...
function visualize_bisection_gif(f, a, b, delta, epsilon, maxit)
    ...
    plot!(p, x_vals, y_vals, label="f(x) = 3.0 * x - e^x", linewidth=2)
...
visualize_bisection_gif(f_bisection, 0.0, 2.0, delta, epsilon, 5)
=#
